...
namespace WindowsFormsApp5 {
    ...
    [global::System.Xml.Serialization.XmlRootAttribute("petrov1122DataSet1")]
    [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")]
    public partial class petrov1122DataSet1 : global::System.Data.DataSet {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        protected petrov1122DataSet1(global::System.Runtime.Serialization.SerializationInfo info, global::System.Runtime.Serialization.StreamingContext context) : 
        ...
        public override global::System.Data.DataSet Clone() {
            petrov1122DataSet1 cln = ((petrov1122DataSet1)(base.Clone()));
            cln.InitVars();
        ...
        private void InitClass() {
            this.DataSetName = "petrov1122DataSet1";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/petrov1122DataSet1.xsd";
        ...
        public static global::System.Xml.Schema.XmlSchemaComplexType GetTypedDataSetSchema(global::System.Xml.Schema.XmlSchemaSet xs) {
            petrov1122DataSet1 ds = new petrov1122DataSet1();
        ...
        public partial class ПокупателиDataTable : global::System.Data.TypedTableBase<ПокупателиRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ПокупателиRow AddПокупателиRow(string ФИО, string Логин, string Пароль, string Почта, string Телефон, string Адрес) {
            ...
            private void InitClass() {
                ...
                this.columnКод_покупателя.ReadOnly = true;
        ...
        public partial class ПокупателиRow : global::System.Data.DataRow {
            ...
            public string Пароль {
                get {
                    try {
                        return ((string)(this[this.tableПокупатели.ПарольColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Пароль\' в таблице \'Покупатели\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tableПокупатели.ПарольColumn] = value;
                }
            }
            ...
            public bool IsПарольNull() {
                return this.IsNull(this.tableПокупатели.ПарольColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetПарольNull() {
                this[this.tableПокупатели.ПарольColumn] = global::System.Convert.DBNull;
            }
...
namespace WindowsFormsApp5.petrov1122DataSet1TableAdapters {
    ...
    public partial class ПокупателиTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Покупатели] WHERE (([Код_покупателя] = @Original_Код_покупателя) AND ((@IsNull_ФИО = 1 AND [ФИО] IS NULL) OR ([ФИО] = @Original_ФИО)) AND ((@IsNull_Логин = 1 AND [Логин] IS NULL) OR ([Логин] = @Original_Логин)) AND ((@IsNull_Пароль = 1 AND [Пароль] IS NULL) OR ([Пароль] = @Original_Пароль)) AND ((@IsNull_Почта = 1 AND [Почта] IS NULL) OR ([Почта] = @Original_Почта)) AND ((@IsNull_Телефон = 1 AND [Телефон] IS NULL) OR ([Телефон] = @Original_Телефон)) AND ((@IsNull_Адрес = 1 AND [Адрес] IS NULL) OR ([Адрес] = @Original_Адрес)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Покупатели] ([ФИО], [Логин], [Пароль], [Почта], [Телефон], [Адрес]) VALUES (@ФИО, @Логин, @Пароль, @Почта, @Телефон, @Адрес);
SELECT Код_покупателя, ФИО, Логин, Пароль, Почта, Телефон, Адрес FROM Покупатели WHERE (Код_покупателя = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Покупатели] SET [ФИО] = @ФИО, [Логин] = @Логин, [Пароль] = @Пароль, [Почта] = @Почта, [Телефон] = @Телефон, [Адрес] = @Адрес WHERE (([Код_покупателя] = @Original_Код_покупателя) AND ((@IsNull_ФИО = 1 AND [ФИО] IS NULL) OR ([ФИО] = @Original_ФИО)) AND ((@IsNull_Логин = 1 AND [Логин] IS NULL) OR ([Логин] = @Original_Логин)) AND ((@IsNull_Пароль = 1 AND [Пароль] IS NULL) OR ([Пароль] = @Original_Пароль)) AND ((@IsNull_Почта = 1 AND [Почта] IS NULL) OR ([Почта] = @Original_Почта)) AND ((@IsNull_Телефон = 1 AND [Телефон] IS NULL) OR ([Телефон] = @Original_Телефон)) AND ((@IsNull_Адрес = 1 AND [Адрес] IS NULL) OR ([Адрес] = @Original_Адрес)));
SELECT Код_покупателя, ФИО, Логин, Пароль, Почта, Телефон, Адрес FROM Покупатели WHERE (Код_покупателя = @Код_покупателя)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Код_покупателя", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "Код_покупателя", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Код_покупателя, ФИО, Логин, Пароль, Почта, Телефон, Адрес FROM dbo.Покупат" +
                "ели";
        ...
        public virtual int Fill(petrov1122DataSet1.ПокупателиDataTable dataTable) {
        ...
        public virtual petrov1122DataSet1.ПокупателиDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            petrov1122DataSet1.ПокупателиDataTable dataTable = new petrov1122DataSet1.ПокупателиDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(petrov1122DataSet1.ПокупателиDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(petrov1122DataSet1 dataSet) {
        ...
        public virtual int Delete(int Original_Код_покупателя, string Original_ФИО, string Original_Логин, string Original_Пароль, string Original_Почта, string Original_Телефон, string Original_Адрес) {
        ...
        public virtual int Insert(string ФИО, string Логин, string Пароль, string Почта, string Телефон, string Адрес) {
            if ((ФИО == null)) {
        ...
        public virtual int Update(string ФИО, string Логин, string Пароль, string Почта, string Телефон, string Адрес, int Original_Код_покупателя, string Original_ФИО, string Original_Логин, string Original_Пароль, string Original_Почта, string Original_Телефон, string Original_Адрес, int Код_покупателя) {
            if ((ФИО == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(Original_Код_покупателя));
            if ((Original_ФИО == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[19].Value = ((int)(Код_покупателя));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ФИО, string Логин, string Пароль, string Почта, string Телефон, string Адрес, int Original_Код_покупателя, string Original_ФИО, string Original_Логин, string Original_Пароль, string Original_Почта, string Original_Телефон, string Original_Адрес) {
            return this.Update(ФИО, Логин, Пароль, Почта, Телефон, Адрес, Original_Код_покупателя, Original_ФИО, Original_Логин, Original_Пароль, Original_Почта, Original_Телефон, Original_Адрес, Original_Код_покупателя);
        }
    }
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        private int UpdateUpdatedRows(petrov1122DataSet1 dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._покупателиTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        private int UpdateInsertedRows(petrov1122DataSet1 dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._покупателиTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        private int UpdateDeletedRows(petrov1122DataSet1 dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            if ((this._покупателиTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        public virtual int UpdateAll(petrov1122DataSet1 dataSet) {
            if ((dataSet == null)) {
